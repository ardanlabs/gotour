...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>यह किसी भी मध्यवर्ती स्तर के डेवलपर के लिए सामग्री है जिसके पास अन्य प्रोग्रामिंग भाषाओं के साथ कुछ अनुभव है और गो सीखना चाहता है। हमारा मानना है कि यह सामग्री उन लोगों के लिए एकदम सही है जो गो सीखने में एक त्वरित शुरुआत चाहते हैं या जो भाषा और उसके आंतरिक पहलुओं की अधिक गहन समझ चाहते हैं।</p>
    <p><b>पहली बार जब आप कोई उदाहरण चलाते हैं तो उसे पूरा होने में कुछ समय लग सकता है। ऐसा इसलिए है क्योंकि टूर सेवा शायद नहीं चल रही होगी. कृपया इसे पूरा करने के लिए कुछ समय दें।</b></p>
    `,
    'lessons': [
        'welcome',
    ]
