...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Ceci est important pour tout développeur de niveau intermédiaire qui a une certaine expérience avec d’autres langages de programmation et souhaite apprendre Go. Nous pensons que ce matériel est parfait pour tous ceux qui souhaitent démarrer dans l’apprentissage du Go ou qui souhaitent une compréhension plus approfondie du langage et de ses composants internes.</p>
    <p><b>La première fois que vous exécutez un exemple, son exécution peut prendre un certain temps. En effet, le service de visite pourrait ne pas fonctionner. Veuillez lui donner un peu de temps pour le terminer.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
