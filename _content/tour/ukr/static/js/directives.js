...
angular
    ...
    .directive('settitle', function () {
        return function (scope, elm, attrs) {
            ...
            if (!str) return $('title').html(`Ultimate Go : ${section}`);
    ...
    .directive('searchButton', [
        ...
        function (i18n) {
            ...
            return {
                restrict: 'A',
                templateUrl: '/tour/ukr/static/partials/search-button.html',
    ...
    .directive('searchContents', function () {
        ...
        return {
            restrict: 'A',
            templateUrl: '/tour/ukr/static/partials/search.html',
    ...
    .directive('tableOfContentsButton', [
        'i18n',
        function (i18n) {
            var speed = 250;
            return {
                restrict: 'A',
                templateUrl: '/tour/ukr/static/partials/toc-button.html',
                link: function (scope, elm, attrs) {
    ...
    .directive('tableOfContents', [
        ...
        function ($routeParams, toc) {
            ...
            return {
                restrict: 'A',
                templateUrl: '/tour/ukr/static/partials/toc.html',
                link: function (scope, elm) {
                    scope.toc = toc;
    ...
    .directive('feedbackButton', [
        'i18n',
        function (i18n) {
            return {
                restrict: 'A',
                templateUrl: '/tour/ukr/static/partials/feedback-button.html',
                link: function (scope, elm, attrs) {
                    scope.feedbackMessage = i18n.l('submit-feedback');

                    elm.on('click', function () {
                        var context =
                            window.location.pathname === '/tour/ukr/list'
                                ? '/tour/ukr/list'
                                : '/tour/ukr/' + scope.params.lessonId + '/' + scope.params.pageNumber;
