...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Αυτό είναι υλικό για κάθε προγραμματιστή μεσαίου επιπέδου που έχει κάποια εμπειρία με άλλες γλώσσες προγραμματισμού και θέλει να μάθει Go. Πιστεύουμε ότι αυτό το υλικό είναι τέλειο για οποιονδήποτε θέλει μια γρήγορη εκκίνηση στην εκμάθηση του Go ή που θέλει μια πιο εμπεριστατωμένη κατανόηση της γλώσσας και των εσωτερικών της στοιχείων.</p>
    <p><b>Την πρώτη φορά που εκτελείτε ένα παράδειγμα, μπορεί να χρειαστεί λίγος χρόνος για να ολοκληρωθεί. Αυτό συμβαίνει επειδή η υπηρεσία περιήγησης ενδέχεται να μην εκτελείται. Δώστε του λίγο χρόνο για να ολοκληρωθεί.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
