...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Bu boshqa dasturlash tillari bilan tajribaga ega bo'lgan va Go'ni o'rganmoqchi bo'lgan har qanday o'rta darajadagi dasturchi uchun materialdir. Bizning fikrimizcha, ushbu material Go-ni o'rganishni zudlik bilan boshlashni xohlaydigan yoki til va uning ichki qismlarini chuqurroq tushunishni istagan har bir kishi uchun juda mos keladi.</p>
    <p><b>Misolni birinchi marta ishga tushirganingizda, uni bajarish uchun biroz vaqt ketishi mumkin. Buning sababi, sayohat xizmati ishlamayotgan bo'lishi mumkin. Iltimos, bajarish uchun biroz vaqt bering.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
