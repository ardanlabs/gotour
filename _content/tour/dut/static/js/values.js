...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Dit is materiaal voor elke ontwikkelaar op gemiddeld niveau die enige ervaring heeft met andere programmeertalen en Go wil leren. Wij geloven dat dit materiaal perfect is voor iedereen die een vliegende start wil maken met het leren van Go of die een grondiger begrip wil van de taal en de interne werking ervan.</p>
    <p><b>De eerste keer dat u een voorbeeld uitvoert, kan het enige tijd duren voordat het is voltooid. Dit komt omdat de tourservice mogelijk niet actief is. Geef het alstublieft wat tijd om het te voltooien.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
