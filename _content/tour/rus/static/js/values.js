...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Это материал для разработчика среднего уровня, имеющего некоторый опыт работы с другими языками программирования и желающего изучить Go. Мы считаем, что эти материалы идеально подходят для тех, кто хочет быстро начать обучение Go или желает более глубокого понимания языка и его внутренней структуры.</p>
<p><b>В первый раз, когда вы запустите пример, это может занять некоторое время. Это потому, что сервис тура может быть не запущен. Пожалуйста, дайте ему некоторое время для завершения.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
