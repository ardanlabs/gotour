...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Ini adalah materi untuk pengembang tingkat menengah mana pun yang memiliki pengalaman dengan bahasa pemrograman lain dan ingin mempelajari Go. Kami yakin materi ini sangat cocok bagi siapa saja yang ingin memulai pembelajaran Go atau yang menginginkan pemahaman yang lebih menyeluruh tentang bahasa dan internalnya.</p>
    <p><b>Saat pertama kali Anda menjalankan contoh, mungkin diperlukan waktu beberapa saat untuk menyelesaikannya. Sebab, layanan tur mungkin tidak berjalan. Tolong beri waktu untuk menyelesaikannya.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
