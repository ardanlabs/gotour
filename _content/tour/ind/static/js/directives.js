...
directive('searchButton', ['i18n', function(i18n) {
    ...
    return {
        restrict: 'A',
        templateUrl: '/tour/ind/static/partials/search-button.html',
...
directive('searchContents', function() {
    ...
    return {
        restrict: 'A',
        templateUrl: '/tour/ind/static/partials/search.html',
...
directive('tableOfContentsButton', ['i18n', function(i18n) {
    ...
    return {
        restrict: 'A',
        templateUrl: '/tour/ind/static/partials/toc-button.html',
        link: function(scope, elm, attrs) {
...
directive('tableOfContents', ['$routeParams', 'toc',
    function($routeParams, toc) {
        ...
        return {
            restrict: 'A',
            templateUrl: '/tour/ind/static/partials/toc.html',
            link: function(scope, elm) {
                scope.toc = toc;
...
directive('feedbackButton', ['i18n', function(i18n) {
    return {
        restrict: 'A',
        templateUrl: '/tour/ind/static/partials/feedback-button.html',
        link: function(scope, elm, attrs) {
            scope.feedbackMessage = i18n.l('submit-feedback');

            elm.on('click', function() {
                var context = window.location.pathname === '/tour/ind/list'
                    ? '/tour/ind/list'
                    : '/tour/ind/' + scope.params.lessonId + '/' + scope.params.pageNumber;
