...
angular
  ...
  .directive("searchButton", [
    ...
    function (i18n) {
      ...
      return {
        restrict: "A",
        templateUrl: "/tour/ben/static/partials/search-button.html",
  ...
  .directive("searchContents", function () {
    ...
    return {
      restrict: "A",
      templateUrl: "/tour/ben/static/partials/search.html",
  ...
  .directive("tableOfContentsButton", [
    ...
    function (i18n) {
      ...
      return {
        restrict: "A",
        templateUrl: "/tour/ben/static/partials/toc-button.html",
        link: function (scope, elm, attrs) {
  ...
  .directive("tableOfContents", [
    ...
    function ($routeParams, toc) {
      ...
      return {
        restrict: "A",
        templateUrl: "/tour/ben/static/partials/toc.html",
        link: function (scope, elm) {
          scope.toc = toc;
          ...
          scope.$watch(
            ...
            function () {
              $(
                ".toc-lesson:not(#toc-l-" +
                  scope.params.lessonId +
                  ") .toc-page"
              ).slideUp(speed);
            }
          );
  ...
  .directive("feedbackButton", [
    ...
    function (i18n) {
      return {
        restrict: "A",
        templateUrl: "/tour/ben/static/partials/feedback-button.html",
        link: function (scope, elm, attrs) {
          scope.feedbackMessage = i18n.l("submit-feedback");

          elm.on("click", function () {
            var context =
              window.location.pathname === "/tour/ben/list"
                ? "/tour/ben/list"
                : "/tour/ben/" +
                  scope.params.lessonId +
                  "/" +
