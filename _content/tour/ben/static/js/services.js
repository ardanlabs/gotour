  ...
  .factory("run", [
    ...
    function (win, editor) {
      ...
      return function (code, output, options, done) {
        ...
        // the txtar archive.
        //
        // The exercises use github.com/ardanlabs/gotour/external/tour/ben/{pic,reader,tree,wc}
        ...
        return win.transport.Run(
          code,
          writeInterceptor(PlaygroundOutput(output), done),
          options
        );
      };
    },
