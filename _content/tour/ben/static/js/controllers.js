...
angular
  ...
  .controller("EditorCtrl", [
    ...
    function (
      ...
      function file() {
        return lessons[$scope.lessonId].Pages[$scope.curPage - 1].Files[
          $scope.curFile
        ];
      }
    ...
    function ($scope, $http) {
      ...
      $scope.performSearch = function () {
        if ($scope.searchTerm && $scope.searchTerm.length >= 3) {
          $http
            .get("/tour/ben/bleve/", { params: { search: $scope.searchTerm } })
