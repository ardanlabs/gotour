...
// Δείγμα προγράμματος, προκειμένου να παρουσιαστεί ο συντακτικός κανόνας
// επιβεβαιώσεων τύπου.
package main
...
// Η run πραγματοποιεί την λειτουργία αναζήτησης στα πραγματικά δεδομένα,
// που περνάνε στην κλήση.
func run(f finder) error {
	...
	// Μπορείτε να χρησιμοποιήσετε μια διαβεβαίωση τύπου, προκειμένου να
	// πάρετε ένα αντίγραφο του δείκτη διεύθυνσης userSVC, που είναι
	//αποθηκευμένος στην διεπαφή.
	svc := f.(*userSVC)
