...
func heapSort(numbers []int) []int {
	...
	// Χωρίστε την λίστα στην μέση και επεξεργαστείτε το μπροστινό μισό
...
func moveLargest(numbers []int, size int, index int) []int {
	...
	// Υπολογίστε την απόκλιση του δείκτη, ώστε οι αριθμοί στην λίστα να
	...
	// Αποθηκεύστε τον προσδιορισμένο δείκτη ως τον δείκτη με την τρέχουσα
	// μεγαλύτερη τιμή.
