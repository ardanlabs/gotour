...
func Reverse(num int) int {
	...
	for num != 0 {
		...
		// Πραγματοποιείστε την λειτουργία υπολοίπου ακέραιας
		// διαίρεσης (στμ. modulus) προκειμένου να πάρετε το
		// τελευταίο ψηφίο από την τιμή, που έχει ανατεθεί στην num.
