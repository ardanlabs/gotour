...
// Αυτό το δείγμα προγράμματος παρουσιάζει τον τρόπο εξακρίβωσης,
//
//	αν μια συμβολοσειρά είναι μια αντιμετάθεση ή όχι.
package main
...
// Η IsPermutation ελέγχει αν δύο συμβολοσειρές είναι αντιμεταθέσεις,
// η μια της άλλης.
