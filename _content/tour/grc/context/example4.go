...
// ΔΕίγμα προγράμματος, προκειμένου να παρουσιαστεί ο τρόπος χρήσης της συνάρτησης
// WithTimeout του πακέτου Context.
package main
...
func main() {
	...
	// Δημιουργείστε μια context, που μπορεί να ακυρωθεί χειροκίνητα και
	// να σηματοδοτήσει μια ακύρωση στην συγκεκριμένη διάρκεια.
