...
// Δείγμα προγράμματος, προκειμένου να παρουσιαστεί ο τρόπος ανάκτησης ελέγχου
// (recover) από καταστάσεις panic.
package main
...
// Η testPanic μιμείται μια συνάρτηση που συναντά μια κατάσταση panic,
//
//	προκειμένου να ελέγξουμε την συνάρτηση catchPanic.
func testPanic() (err error) {
	...
	// Μια προσπάθεια πρόσβασης στην διεύθυνση μνήμης που δείχνει ένας
	// δείκτης διεύθυνσης με την τιμή nil, θα προκαλέσει το εκτελέσιμο
	// περιβάλλον να μπει σε κατάσταση panic.
	var p *int
	*p = 10
