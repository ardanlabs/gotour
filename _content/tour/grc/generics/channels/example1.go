...
// Δείγμα προγράμματος, που παρουσιάζει τον τρόπο εκτέλεσης μιας συνάρτησης
// εργασίας σε μια goroutine και την επιστροφή ενός καναλιού επικοινωνίας
// τύπου Result (που θα προσδιοριστεί αργότερα) πίσω στον καλώντα.
package main
