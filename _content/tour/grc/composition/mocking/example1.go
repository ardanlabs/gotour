...
// Δείγμα προγράμματος, προκειμένου να παρουσιαστεί πως μπορεί κανείς να μιμηθεί 
// πραγματικούς τύπους όταν χρειάζεται, για τα πακέτα ή για ελέγχους.
package main
...
// Ο mock είναι ένας πραγματικός τύπος, που βοηθά την υποστήριξη μίμησης 
// του παλέτου pubsub.
type mock struct{}
...
func main() {
	...
	// Δημιουργήστε μια φέτα τιμών διεπαφής publisher. Εκχωρείστε 
