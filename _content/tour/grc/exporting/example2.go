...
// Δείγμα προγράμματος, προκειμένου να παρουσιαστεί ο τρόπος πρόσβασης σε ένα
// εξαγόμενο αναγνωριστικό.
package main
...
func main() {
	...
	// Δημιουργείστε μια μεταβλητή του εξαγόμενου τύπου και δώστε αρχική τιμή 
	// ίση με 10.
