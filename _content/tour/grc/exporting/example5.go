...
// Δείγμα προγράμματος, προκειμένου να παρουσιαστεί πως δημιουργούνται τιμές, 
// από εξαγόμενους τύπους, με ενσωματωμένους μη εξαγόμενους τύπους.
package main
...
func main() {
	...
	// Εκχωρείστε τιμή στα εξαγόμενα πεδία, από τον μη εξαγόμενο εσωτερικό
	// τύπο χρήστη.
	u.Name = "Chole"
	u.ID = 10
