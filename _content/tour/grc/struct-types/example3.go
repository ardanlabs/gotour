...
// Δείγμα προγράμματος προκειμένου να παρουσιαστεί πως μεταβλητές ενός ανώνυμου τύπου
// μπορούν να εκχωρηθούν σε μεταβλητές ενός επώνυμου τύπου, όταν αυτοί είναι
// ίδιοι.
package main
