...
// ΔΕίγμα προγράμματος, προκειμένου να παρουσιαστεί τι συμβαίνει όταν ο εξώτερος
// και ο εσώτερος τύπος υλοποιούν την ίδια διεπαφή.
package main
...
func main() {
	...
	// Μπορούμε να έχουμε πρόσβαση στην μέθοδο τύπου του εσωτερικού
	// τύπου απευθείας.
	ad.user.notify()
