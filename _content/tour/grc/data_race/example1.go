...
// Δείγμα προγράμματος, προκειμένου να παρουσιαστεί ο τρόπος δημιουργίας συνθηκών
// ανταγωνισμού για δεδομένα (στμ. data race) στα προγράμματα μας. Αυτό είναι κάτι
// το οποίο δεν θέλουμε να το κάνουμε.
package main
...
func main() {
	...
	// Ο αριθμός των ρουτινών συνεκτέλεσης της Go προς χρήση.
	const grs = 2
