...
value('tableOfContents', [{
    'id': 'welcome',
    'title': '',
    'description': `<p>Đây là tài liệu dành cho bất kỳ nhà phát triển trình độ trung cấp nào có một số kinh nghiệm với các ngôn ngữ lập trình khác và muốn học Go. Chúng tôi tin rằng tài liệu này là hoàn hảo cho những ai muốn bắt đầu học cờ vây hoặc những ai muốn hiểu kỹ hơn về ngôn ngữ và nội dung bên trong của nó.</p>
    <p><b>Lần đầu tiên bạn chạy một ví dụ, có thể mất chút thời gian để hoàn thành. Điều này là do dịch vụ du lịch có thể không hoạt động. Xin vui lòng cho nó một thời gian để hoàn thành.</b></p>
    `,
    'lessons': [
        'welcome',
    ]
