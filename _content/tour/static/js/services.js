...
factory('run', ['$window', 'editor',
    function(win, editor) {
        ...
        return function(code, output, options, done) {
            ...
            // the txtar archive.
            //
            // The exercises use github.com/ardanlabs/gotour/external/tour/{pic,reader,tree,wc}
            // packages, so include the github.com/ardanlabs/gotour/external/tour module in the
            // build list.
            ...
            if (!hasGoMod) {
                code += '\n' +
                    '-- go.mod --\n' +
                    'module example\n' +
                    'require github.com/ardanlabs/gotour/external/tour v0.0.0-20201207214521-004403599411\n' +
                    '-- go.sum --\n' +
                    ...
                    'github.com/ardanlabs/gotour/external/tour v0.0.0-20201207214521-004403599411 h1:dJ4kVwSGlrLZXW6eo2IOer4Pm3wl2GIG4fytRziMgL8=\n' +
                    'github.com/ardanlabs/gotour/external/tour v0.0.0-20201207214521-004403599411/go.mod h1:qMugOFWX59KzC8Nx7f2uvXxKxAqJfi1J6ZUHAWKnrRA=\n';
            }
